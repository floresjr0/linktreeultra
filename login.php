...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $error = is_string($result) ? $result : 'Invalid email or password.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="auth-page">
        ...
        <div class="auth-card">
            ...
            <h1>Welcome back</h1>
            <p class="auth-subtitle">Sign in to manage your links</p>
            ...
            <?php if ($expired): ?>
                <div class="alert alert-error" role="alert">
                    ...
                    Your free trial has expired. Pay via GCash and upload proof — once verified, your account is restored with unlimited links.
                </div>
            <?php endif; ?>
            ...
            <form method="POST" class="auth-form" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
                            ...
                            <path d="M2.5 7.5l7.1 4.5a.8.8 0 00.8 0L17.5 7.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>
                        </svg>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
                            <rect x="4" y="9" width="12" height="8.5" rx="2" stroke="currentColor" stroke-width="1.4"/>
